...
import cn.ydw.www.toolslib.utils.download.DownloadTask;
 ...
 * @author 杨德望
 * Create on 2018/7/11
 * 描述:   af0ef77c4e74def2207bc8a21e628953e669a6b5
 * =========================================
 */
public interface ToolConstants {

    String DownloadPathUrl = "UrlPath"; // 下载地址, 唯一值, 作为下载 id 区别
    String DownloadPathLocal = "localPath"; // 下载后本地路径, 唯一值,
    String DownloadTimeWait = "waitTime"; // 申请下载, 但还未启动的时间,
    String DownloadTimeStart = "startTime"; // 下载开始时间,
    String DownloadTimeEnd = "endTime"; // 下载结束时间,
    String DownloadCallback = "callback"; // 下载回调,
    String DownloadSpeed = "downloadSpeed";// 下载速度
    String DownloadProgress = "downloadProgress"; // 下载进度
    String DownloadIsLocal = "isLocal"; // 是否是本地缓存的文件
    int DownloadState_Suc = 1;// 下载成功
    int DownloadState_Wait = 0;// 下载中
    int DownloadState_Err = -1;// 下载失败
    int DownloadBackId = 10;// handler回馈的id

    //下载缓存
    HashMap<String, String> mCacheDownloadFile = new HashMap<>();
    //下载控件缓存
    HashMap<String, WeakReference<DownloadTask>> mCacheNetCall = new HashMap<>();
