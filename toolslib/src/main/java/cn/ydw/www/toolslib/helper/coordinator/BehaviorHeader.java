 ...
 * =========================================
 */
public class BehaviorHeader extends CoordinatorLayout.Behavior<View> {
    private float lastPointY = -1;
    public BehaviorHeader(Context context, AttributeSet attrs) {
        super(context, attrs);
    }
    ...
    public boolean onDependentViewChanged(CoordinatorLayout parent, View child, View dependency) {
        if (lastPointY == -1) {
            lastPointY = dependency.getY();
        }
        float offsetY = dependency.getY() - lastPointY;
