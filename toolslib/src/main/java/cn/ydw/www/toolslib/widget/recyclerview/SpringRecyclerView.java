...
public class SpringRecyclerView extends TempRecyclerView {
    ...
    private int mReleaseBackAnimDuration; // 在我们释放视图后的反弹动画的持续时间。毫秒。
    private int mFlingBackAnimDuration;//快速滑动视图后的反弹动画的持续时间。毫秒。
    ...
    private boolean mEnableSpringEffectWhenDrag; //当我们拖动 retriclerview 到 overScroll 时，是否启用了弹簧效果。
    private boolean mEnableSpringEffectWhenFling; //当我们快速滑动RecyclerView时是否启用了弹簧效果。
    ...
    public boolean onInterceptTouchEvent(MotionEvent ev) {
        return mEnableSpringEffectWhenDrag && onInterceptTouchEventInternal(ev) || super.onInterceptTouchEvent(ev);
    }
    ...
    public boolean onTouchEvent(MotionEvent ev) {
        return mEnableSpringEffectWhenDrag && onTouchEventInternal(ev) || super.onTouchEvent(ev);
    }
