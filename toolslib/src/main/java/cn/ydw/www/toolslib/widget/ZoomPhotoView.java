 ...
 * 手势图片控件, 可以放大缩小图片
 */
public class ZoomPhotoView extends android.support.v7.widget.AppCompatImageView  {
    ...
    public boolean canScrollHorizontally(int direction) {
        if (mPinchMode == ZoomPhotoView.PINCH_MODE_SCALE) {
            return true;
        }
    ...
    public interface OuterMatrixChangedListener {
         ...
         */
        void onOuterMatrixChanged(ZoomPhotoView pinchImageView);
    }
     ...
     * 在onTouchEvent末尾被执行.
     */
    private GestureDetector mGestureDetector = new GestureDetector(ZoomPhotoView.this.getContext(), new GestureDetector.SimpleOnGestureListener() {
        ...
        public void onLongPress(MotionEvent e) {
            ...
            if (mOnLongClickListener != null) {
                mOnLongClickListener.onLongClick(ZoomPhotoView.this);
            }
        }
        ...
        public boolean onSingleTapConfirmed(MotionEvent e) {
            ...
            if (mOnClickListener != null) {
                mOnClickListener.onClick(ZoomPhotoView.this);
            }
            return true;
        }
    });
