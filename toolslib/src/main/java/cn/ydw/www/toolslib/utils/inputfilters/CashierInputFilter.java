package cn.ydw.www.toolslib.utils.inputfilters;
...
/**
 * @author  杨德望 create on 2017/5/8.
 * 描述: 这是保证editText只能输入金额的工具类,
 ...
 * 2. 然后java代码设置 mEditText.setFilters(new InputFilter[]{new CashierInputFilter()});
 *
 * 注: 可以使用的过滤器有 {@link android.text.LoginFilter.UsernameFilterGMail} 等...
 */
