...
public class VerificationCodeView extends RelativeLayout {
    ...
    private void init(Context context, AttributeSet attrs, int defStyleAttr) {
        inflate(context, R.layout.layout_identifying_code, this);
        containerEt = this.findViewById(R.id.container_et);
        et = this.findViewById(R.id.et_verification_input);
        if (attrs != null) {
            ...
            mEtWidth = typedArray.getDimensionPixelSize(R.styleable.VerificationCodeView_icv_et_width, 40);
            mEtDividerDrawable = typedArray.getDrawable(R.styleable.VerificationCodeView_icv_et_divider_drawable);
            mEtTextSize = typedArray.getDimensionPixelSize(R.styleable.VerificationCodeView_icv_et_text_size, ScreenUtils.sp2px(context, 12));
            ...
            mEtNumber = 1;
            mEtWidth = 40;
            mEtTextSize = ScreenUtils.sp2px(context, 12);
            mEtTextColor =  Color.BLACK;
            mEtPwd = false;
            mEtPwdRadius = 0;
        }
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        if (heightMode == MeasureSpec.AT_MOST) {
            mHeightMeasureSpec = MeasureSpec.makeMeasureSpec(ScreenUtils.dip2px( getContext(), 50), MeasureSpec.EXACTLY);
        }
    ...
    // 给TextView 设置文字
    private void setText(CharSequence inputContent) {
     ...
     * 设置是否是密码模式 默认不是
     *
     * @param isPwdMode 是否是密码模式, true 为是
     */
    ...
    private class MyTextWatcher implements TextWatcher {
        ...
        public void afterTextChanged(Editable editable) {
            ...
            if (!TextUtils.isEmpty(inputStr)) {
                char[] mChars = inputStr.toCharArray();
//                String[] strArray = inputStr.split("");
                for (int i = 0; i < mChars.length; i++) {
                    ...
                    setText(String.valueOf(mChars[i]));
                }
                et.setText("");
            }
        }
